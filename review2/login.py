...
class Login:
   ...
   def __init__(self,root):
      self.root=root
      self.root.title("Login and registration system for Event Management System")
   ...
   def appscreen(self):
      ...
      label1=Label(Frame_login,text="Welcom to event management system."
      ...
      label2=Label(Frame_login,text="Click the required button you want"
      ...
      btn2=Button(Frame_login,text="Logout",command=self.loginform,cursor="hand2",
                  ...
                  font=("times new roman",15),fg="white",bg="#342D7E",
